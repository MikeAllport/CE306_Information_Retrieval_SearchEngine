...
namespace Assignment1
{
        ...
        IEqualityComparer<MovieIndex>
    {
        ...
        public bool Equals( MovieIndex x,  MovieIndex y)
        {
        ...
        public int Compare(MovieIndex x, MovieIndex y)
        {
        ...
        /// <returns></returns>
        public int GetHashCode(MovieIndex obj)
        {
        ...
        /// </summary>
        public int CompareTo(MovieIndex other)
        {
